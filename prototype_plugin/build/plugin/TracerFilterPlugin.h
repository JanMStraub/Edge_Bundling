...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/TracerFilterPlugin")
#endif
public:
  TracerFilterPlugin();
  ...
  const char* GetDescription() override
    { return "Tracer is a filter that integrates a vector field to generate streamlines and pathlines."; }
