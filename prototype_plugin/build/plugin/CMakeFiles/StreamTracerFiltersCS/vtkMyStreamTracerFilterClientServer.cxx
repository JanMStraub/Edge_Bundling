// ClientServer wrapper for vtkStreamlineTracer object
//
#define VTK_WRAPPING_CXX
#define VTK_STREAMS_FWD_ONLY
#include "vtkStreamlineTracer.h"
#include "vtkSystemIncludes.h"
#include "vtkClientServerInterpreter.h"
#include "vtkClientServerStream.h"


vtkObjectBase *vtkStreamlineTracerClientServerNewCommand(void* /*ctx*/)
{
  return vtkStreamlineTracer::New();
}


int VTK_EXPORT vtkStreamlineTracerCommand(
...
{
  vtkStreamlineTracer *op = vtkStreamlineTracer::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkStreamlineTracer.  "
  ...
  if (!strcmp("IsTypeOf",method) && msg.GetNumberOfArguments(0) == 3)
    ...
    if(msg.GetArgument(0, 2, &temp0))
      {
      temp20 = vtkStreamlineTracer::IsTypeOf(temp0);
      resultStream.Reset();
  ...
  if (!strcmp("GetNumberOfGenerationsFromBaseType",method) && msg.GetNumberOfArguments(0) == 3)
    ...
    if(msg.GetArgument(0, 2, &temp0))
      {
      temp20 = vtkStreamlineTracer::GetNumberOfGenerationsFromBaseType(temp0);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkStreamlineTracer, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkStreamlineTracer_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = nullptr;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkStreamlineTracer", vtkStreamlineTracerClientServerNewCommand);
    csi->AddCommandFunction("vtkStreamlineTracer", vtkStreamlineTracerCommand);
    }
}
