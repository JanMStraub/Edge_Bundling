...
#ifndef vtkStreamlineTracer_h
#define vtkStreamlineTracer_h
...
class VTKFILTERSFLOWPATHS_EXPORT vtkStreamlineTracer : public vtkPolyDataAlgorithm {
  public:
      vtkTypeMacro(vtkStreamlineTracer, vtkPolyDataAlgorithm);
       ...
       * (in arc length unit).
       */
      static vtkStreamlineTracer* New();
  ...
  private:
    vtkStreamlineTracer(const vtkStreamlineTracer&) = delete;
    void operator=(const vtkStreamlineTracer&) = delete;
};
