...
class LagrangianIntegrationModelPlugin :
#if _paraview_add_plugin_with_ui
  public QObject,
...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/LagrangianIntegrationModelPlugin")
#endif
public:
  LagrangianIntegrationModelPlugin();

  /**
   * Returns the name for this plugin.
   */
  const char* GetPluginName() override
    {return "LagrangianIntegrationModel"; }
  ...
  const char* GetDescription() override
    { return "An example plugin for implementing your own LagrangianIntegrationModel to be used in the LagrangianParticleTracker."; }
